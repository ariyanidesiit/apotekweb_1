...
<html>
    ...
    <!-- End of Navbar Menu -->
        ...
        <!---form--->
         <div class="views">
            <h2>Tambah Data Spesialisasi</h2>
                <form method="POST" action="input_distributor.php">
                  <div class="form-group">
                    <label for="id_spesialisasi">id Spesialisasi</label>
                    <input class="form-control" type="text" placeholder="id_spesialisasi" name="id_spesialisasi">
                  </div>
                  <div class="form-group">
                    <label for="nama_spesialisasi">Nama Spesialisasi</label>
                    <input class="form-control" type="text" placeholder="nama_spesialisasi" name="nama_spesialisasi">
                  </div>
                  <div class="form-group">
                    <label for="aktif">Aktif</label>
                    <input class="form-control" type="text" placeholder="aktif" name="aktif">
                  </div>
